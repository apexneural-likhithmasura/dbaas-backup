...
# Instantiate OpenRouter client using OpenAI-compatible API (reads OPENROUTER_API_KEY from env)
...
async def websocket_endpoint(websocket: WebSocket) -> None:
	...
	try:
		...
		# Stream tokens from OpenRouter (Claude) and forward to the WebSocket client
